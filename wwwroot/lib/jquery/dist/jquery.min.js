...
!function(t,n){"function"==typeof define&&define.amd?define(["jquery"],n):"object"==typeof exports?module.exports=n(require("jquery")):t.VerticalLoop=n(t.jQuery)}(this,(function(t){var n=function(n,e){this.opt=t.extend({delay:5e3,order:"asc",oninitend:function(t){}},e),this.container=t(n),this.items=this.container.find("li"),this.index=0,this.pager=null,this.animating=!1,this.screen=!1,this.mouseIn=!1,this._init()};return n.prototype={Constructor:n,_init:function(){var n=this,e=this.container.find("ul").clone();if("asc"===this.opt.order)e.appendTo(this.container);else if("desc"===this.opt.order){e.prependTo(this.container);var i=e.height();e.css("marginTop","-"+i+"px")}this._to(0),this.container.on("mouseenter mousemove",(function(){n.mouseIn=!0,n.autoPause()})),this.container.on("mouseleave",(function(){n.mouseIn=!1,n._isInScreen()&&n.autoStart()})),this._isInScreen()&&(n.autoStart(),n.screen=!0),t(window).scroll((function(){n._isInScreen()&&!1===n.screen?(n.screen=!0,n.autoStart()):n._isInScreen()||!0!==n.screen||(n.screen=!1,n.autoPause())})),this.opt.oninitend.call(this,this.container)},autoStart:function(){var t=this;this.timer=setInterval((function(){t._next()}),this.opt.delay)},autoPause:function(){clearInterval(this.timer)},_next:function(){this._to(this.index)},_to:function(t){var n=this.container.find("ul").eq(0),e=this.container.height(),i=n.find("li").length,o=this,r=n.height(),s=n.find("li").height(),c=parseInt(e/s,10)||1,a=parseInt(i/c,10)||1,h=0-t*e;"asc"===this.opt.order||"desc"===this.opt.order&&(h=0-(r+h)),n.animate({marginTop:h+"px"},1e3,(function(){t===a?("asc"===o.opt.order?n.css("marginTop",0):"desc"===o.opt.order&&n.css("marginTop",0-r),o.index=1):o.index=t+1}))},_isInScreen:function(){var n=this.container;if(n.length>0)return t(document).scrollTop()+t(window).height()>n.offset().top&&n.offset().top+n.height()>t(document).scrollTop()}},t.fn.verticalLoop=function(e){return this.each((function(){var i=t(this),o=i.data("snVerticalLoop"),r={},s="";"object"==typeof e&&(r=e),"string"==typeof e&&(s=e),o||(o=new n(i,r),i.data("snVerticalLoop",o)),s&&o[s]()}))},t.fn.verticalLoop.Constructor=n,n}));
/*!
