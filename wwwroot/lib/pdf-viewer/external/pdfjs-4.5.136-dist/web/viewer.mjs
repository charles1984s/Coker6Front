...
};
{
    defaultOptions.defaultUrl = {
        value: "/lib/pdf-viewer/external/pdfjs-4.5.136-dist/web/compressed.tracemonkey-pldi-09.pdf",
        kind: OptionKind.VIEWER
    };
...
const PDFViewerApplication = {
    ...
    async run(config) {
        ...
        appConfig.toolbar.close.addEventListener("click", function () {
