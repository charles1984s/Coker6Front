...
var FileApi={insertNotFondFile:function(t){return $.ajax({url:"/api/File/insertNotFondFile",type:"POST",contentType:"application/json; charset=utf-8",data:JSON.stringify(t),dataType:"json"})}};function jqueryExtend(){$.fn.extend({imgCheck:function(){var t=$(this);return t.each((function(t,e){$(e).on("error",(function(){FileApi.insertNotFondFile({Url:$(e).attr("src"),FK_WebsiteID:"undefined"==typeof SiteId?0:SiteId}),$(e).attr("src","/images/noImg.jpg")}))})),t}})}
