...
function SwiperInit(e){var i={slidesPerView:1,spaceBetween:15,keyboard:{enabled:!0}};if($.fn.extend({swiperBindEven:function(e){const i=function(){e.autoplay.stop()},t=function(){e.autoplay.start()};$(this).find(".swiper").prepend($(this).find(".swiper_button_prev")),$(this).off("mouseover").on("mouseover",i),$(this).find("a").on("focus",i),$(this).off("mouseout").on("mouseout",t),$(this).find("a").on("blob",t),$(this).find("button").prop("disabled",!1)}}),$(".one_swiper").prop("draggable",!0).each((function(){var t=$(this);if(!t.data("isInit")){var a="#"+t.attr("id")+" > .swiper";const o=$(a).find(".swiper-slide").parents(".templatecontent,.template_slide");if(1==$(a).find(".swiper-slide").length&&o.length>0)return!1;const d=0===o.length?$(a).find(".swiper-slide").length>1:$(a).find(".swiper-slide").length>2;var r=t.data("effect"),s=t.data("effect-speed");void 0!==r&&!1!==r||(r="slide"),s=void 0===s||!1===s?300:parseInt(s);var n=!!e.autoplay&&d,p=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},effect:r,speed:s},n?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{},d?{navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"}}:{});d||$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").remove();var l=new Swiper(a,p);t.data("isInit",!0),n&&l.slides.length-2>1&&t.swiperBindEven(l)}})),$(".one_swiper_thumbs").prop("draggable",!0).each((function(){var t=$(this);const a=t.index(this);if(t.find(".six_thumbs > .swiper-wrapper").empty(),!t.data("isInit")){var r="#"+t.attr("id")+" .swiper";const w=$(r).find(".swiper-slide").length>=2;var s=t.data("effect"),n=t.data("effect-speed"),p=new Swiper(".six_thumbs",{loop:!1,spaceBetween:10,slidesPerView:6,freeMode:!0,watchSlidesProgress:!0});void 0!==s&&!1!==s||(s="slide"),n=void 0===n||!1===n?300:parseInt(n);var l=!!e.autoplay&&w,o=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},thumbs:{swiper:p},effect:s,speed:n},l?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{},w?{navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"}}:{});if(w||$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").remove(),!t.find(".swiper").hasClass(".selfThumbs")){const e=[],i=[],a=[];if(t.find(".swiper-slide img").each((function(){e.push($(this).attr("src")),i.push($(this).attr("alt")),$(this).closest(".swiper-slide").hasClass("backstageType")?a.push("backstageType"):a.push("")})),e.length>1)for(let t=0;t<e.length;t++){const r=`<div class="swiper-slide ${a[t]}"><img src="${e[t]}" alt="${i[t]}" /></div>`;p.appendSlide(r)}}p.slideTo(a,0);var d=new Swiper(r,o);t.data("isInit",!0),l&&d.slides.length-2>1&&t.swiperBindEven(d)}})),$(".two_swiper").prop("draggable",!0).each((function(){var t=$(this);if(!t.data("isInit")){var a="#"+t.attr("id")+" > .swiper";const p=0===$(a).find(".swiper-slide").parents(".templatecontent,.template_slide").length?$(a).find(".swiper-slide").length:$(a).find(".swiper-slide").length-1,l=p>2;var r=!!e.autoplay&&l,s=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0,renderBullet:function(e,i){return t.has(".swiper_pagination_water").length?'<span class="'+i+' material-symbols-outlined ms-3">water_drop</span>':'<span class="'+i+'"></span>'}},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{400:{slidesPerView:1},1024:{slidesPerView:2}}},r?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{});!l&&p>0&&$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").remove();var n=new Swiper(a,s);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(n),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".three_swiper").prop("draggable",!0).each((function(){var t=$(this);if(!t.data("isInit")){var a="#"+t.attr("id")+" > .swiper",r=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper-pagination",clickable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{375:{slidesPerView:1},576:{slidesPerView:2},992:{slidesPerView:3}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),s=new Swiper(a,r);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(s),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".four_swiper").prop("draggable",!0).each((function(){var t=$(this);if(!t.data("isInit")){var a="#"+t.attr("id")+" > .swiper",r=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper-pagination",clickable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{375:{slidesPerView:1},576:{slidesPerView:3},992:{slidesPerView:4}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),s=new Swiper(a,r);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(s),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".five_swiper").prop("draggable",!0).each((function(){var t=$(this);if(!t.data("isInit")){var a="#"+t.attr("id")+" > .swiper",r=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},scrollbar:{el:".swiper-scrollbar",draggable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{320:{slidesPerView:2},375:{slidesPerView:2},576:{slidesPerView:3},769:{slidesPerView:4},1024:{slidesPerView:5}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),s=new Swiper(a,r);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(s),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".six_swiper").prop("draggable",!0).each((function(){var t=$(this);if(!t.data("isInit")){var a="#"+t.attr("id")+" > .swiper",r=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},scrollbar:{el:".swiper-scrollbar",draggable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{320:{slidesPerView:2},375:{slidesPerView:2},576:{slidesPerView:3},769:{slidesPerView:4},1024:{slidesPerView:6}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),s=new Swiper(a,r);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(s),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".picture-category").length>0&&$("#SwiperModal").length>0){const e=new Swiper("#pictureSwiperThumbs",{spaceBetween:10,breakpoints:{375:{slidesPerView:2},576:{slidesPerView:3},769:{slidesPerView:4},1024:{slidesPerView:6}},loop:!1,freeMode:!0,watchSlidesProgress:!0}),i=new Swiper("#pictureSwiper",{centeredSlides:!0,spaceBetween:10,navigation:{nextEl:"#pictureSwiper .swiper-button-next",prevEl:"#pictureSwiper .swiper-button-prev"},pagination:{el:"#pictureSwiper .swiper-pagination"},thumbs:{swiper:e}});$(".picture-category a").attr("href","#SwiperModal").on("click",(function(){const t=$(this).parents(".picture-category"),a=$(".picture-category a").index(this)>$(".picture-category a").length-2?$(".picture-category a").length-$(".picture-category a").index(this)-1:$(".picture-category a").index(this)-1,r=[];if(t.find(".templatecontent img").each((function(){r.push($(this).attr("src"))})),i.removeAllSlides(),e.removeAllSlides(),1==r.length){const e=`<div class="swiper-slide"><img src="${r[0]}" alt=" " /></div>`;i.appendSlide(e)}else for(let t=1;t<r.length-1;t++){const a=`<div class="swiper-slide"><img src="${r[t]}" alt=" " /></div>`;i.appendSlide(a),e.appendSlide(a)}return i.slideTo(a,0),e.slideTo(a,0),$("#SwiperModal").modal("show"),!1}))}}
...
function FlipBookInit(){console.log("in Flip Book Init");var e=$(".FlipBook");const i={version:"pdfjs-2.1.266-dist",ext:"js"};if(e.addClass("d-none"),void 0!==e.data("pdf")&&e.data("pdf"))var o=e.data("pdf");else console.log("No PDF file specified for FlipBook"),o=`/lib/pdf-viewer/external/${i.version}/web/compressed.tracemonkey-pldi-09.pdf`;var t=document.createElement("div"),n=new XMLHttpRequest;n.onreadystatechange=function(){if(4==this.readyState){200==this.status&&(t.innerHTML=this.responseText),404==this.status&&(t.innerHTML="Page not found."),$(t).find("meta,title,script").remove();const o=[];$.LoadJs(`/lib/pdf-viewer/external/${i.version}/build/pdf.${i.ext}`).done((function(){o.push($.LoadJs(`/lib/pdf-viewer/external/${i.version}/web/viewer.${i.ext}`),$.LoadJs("/lib/pdf-viewer/external/turn.js"),$.LoadJs("/lib/pdf-viewer/pdf-turn/pdf-turn.js"))})),e.append(t),e.removeClass("d-none"),$(".FlipBookModal").length>0&&$.when.apply(null,o).done((function(){/^pdfjs-4/.test(i.version)?FlipBookModalInit({mode:4,lName:"#listeners"}):FlipBookModalInit({mode:3,lName:"_listeners"})}))}},n.open("GET",`/lib/pdf-viewer/external/${i.version}/web/viewer.html?file=${encodeURIComponent(o)}`,!0),n.send()}function FlipBookModalInit(e){var i=$(".FlipBookModal");const o=bootstrap.Modal.getOrCreateInstance(i[0]);let t=null;const n=function(){"undefined"!=typeof bookFlip&&"undefined"!=typeof PDFViewerApplication&&void 0!==PDFViewerApplication.eventBus&&null!=PDFViewerApplication.eventBus?void 0!==$(this).data("init")||$(this).data("init")||(console.log("bookFlip.init"),$(this).data("init",!0),PDFViewerApplication.closeModal=function(){o.hide()},bookFlip.init(e)):t=setTimeout(n,100)};t=setTimeout(n,100),i.on("shown.bs.modal",(e=>{var i=e.relatedTarget.getAttribute("data-pdf-url");PDFViewerApplication.setInitialView(),PDFViewerApplication.open({url:i,originalUrl:i})}))}
