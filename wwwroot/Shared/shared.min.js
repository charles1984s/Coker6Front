...
function ShareBlockInit(){$(".shareBlock").each((function(){void 0!==$(this).data("init")&&$(this).data("init")||($(this).cShare({description:"jQuery plugin - C Share buttons...",showButtons:["email","plurk","twitter","fb","line"],shareToText:"分享至"}),$(this).hover(ProShare),$(this).data("init",!0))}))}function ProShare(){$(this).toggleClass("show")}
