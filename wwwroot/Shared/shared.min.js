...
$.fn.extend({imgCheck:function(){var n=$(this);return n.each((function(n,r){$(r).on("error",(function(){$(r).attr("src","/images/noImg.jpg")}))})),n}});
function FlipBookInit(){var e=$(".FlipBook");if(e.addClass("d-none"),void 0!==e.data("pdf")&&e.data("pdf"))var o=e.data("pdf");else console.log("No PDF file specified for FlipBook"),o="/lib/pdf-viewer/external/pdfjs-2.1.266-dist/web/compressed.tracemonkey-pldi-09.pdf";console.log(o);var t=document.createElement("div");const n=new URL(window.location.href);n.searchParams.set("file",o),window.history.replaceState(null,null,n);var i=new XMLHttpRequest;i.onreadystatechange=function(){4==this.readyState&&(200==this.status&&(t.innerHTML=this.responseText),404==this.status&&(t.innerHTML="Page not found."),e.append(t),e.removeClass("d-none"),console.log("show pdf"),$(".FlipBookModal").length>0&&FlipBookModalInit())},i.open("GET","/lib/pdf-viewer/external/pdfjs-2.1.266-dist/web/viewer.html?file="+encodeURIComponent(o),!0),i.send()}function FlipBookModalInit(){$(".FlipBookModal").on("show.bs.modal",(e=>{var o=e.relatedTarget.getAttribute("data-pdf-url");console.log(o);const t=new URL(window.location.href);t.searchParams.set("file",o),window.history.replaceState(null,null,t),PDFViewerApplication.setInitialView(),PDFViewerApplication.open({url:o,originalUrl:o})}))}