...
var Directory={getDirectoryData:function(e){return $.ajax({url:"/api/Directory/GetReleInfo",type:"POST",contentType:"application/json; charset=utf-8",data:JSON.stringify(e),dataType:"json"})},getDirectoryMenuData:function(e){return $.ajax({url:"/api/Directory/GetReleMenu",type:"POST",contentType:"application/json; charset=utf-8",data:JSON.stringify(e),dataType:"json"})},getDirectoryAdvertiseData:function(e){return $.ajax({url:"/api/Directory/GetReleAd",type:"POST",contentType:"application/json; charset=utf-8",data:JSON.stringify(e),dataType:"json"})},SwitchPage:function(e){return $.ajax({url:"/api/Directory/SwitchPage",type:"POST",contentType:"application/json; charset=utf-8",headers:{Authorization:"Bearer "+localStorage.getItem("token")},data:JSON.stringify(e),dataType:"json"})}},Advertise={ActivityClick:function(e){return $.ajax({url:"/api/Advertise/ActivityClick/",type:"GET",contentType:"application/json; charset=utf-8",data:{FK_Aid:e}})},ActivityExposure:function(e){return $.ajax({url:"/api/Advertise/ActivityExposure/",type:"GET",contentType:"application/json; charset=utf-8",data:{FK_Aid:e}})}};function initElemntAndLoadDir(e,t){const a=e||$(".catalog_frame").first();var n=a.find(".templatecontent").siblings();if(n.length>0)for(i=0;i<n.length;i++)$(n[i]).hasClass("templatecontent-tag")||n[i].remove();const d=void 0!==a.data("dirid")?"string"==typeof a.data("dirid")?a.data("dirid").split(","):[a.data("dirid")]:0;a.data("prevdirid",d);const o=void 0!==a.data("shownum")?a.data("shownum"):12,r=void 0!==a.data("maxlen")&&""!=a.data("maxlen")?a.data("maxlen"):0,s=t?t.toString():location.hash.replace("#",""),l=a.hasClass("getlatlng"),c=void 0!==a.data("longitude")?a.data("longitude"):null,f=void 0!==a.data("latitude")?a.data("latitude"):null;if((void 0===a.data("page")||a.data("page")!=s)&&(t=isNaN(s)||""==s?"1":s,1!=d.length||""!==d[0])){const n={Ids:d,SiteId:"undefined"==typeof SiteId?0:SiteId,Page:t,ShowNum:o,MaxLen:void 0===r?0:r,Filters:a.data("filtered"),directoryType:a.data("directoryTypeChecked"),target:void 0===a.data("target")?null:a.data("target"),FindNearest:l,Longitude:c,Latitude:f};a.find(".catalog>.template").remove(),DirectoryDataGet(a,n),a.off("filter").on("filter",(function(){a.removeData("page"),initElemntAndLoadDir(e,t)})),a.data("page",t)}}function DirectoryGetDataInit(){const e=$(".catalog_frame").length;$(".catalog_frame").each((function(){const e=$(this),t=void 0!==e.data("dirid")?"string"==typeof e.data("dirid")?e.data("dirid").split(","):[e.data("dirid")]:0;void 0!==e.data("prevdirid")&&t==e.data("prevdirid")||initElemntAndLoadDir($(this))})),$(".menu_directory").each((function(){var e=$(this);const t=void 0!==e.data("dirid")?"string"==typeof e.data("dirid")?e.data("dirid").split(","):[e.data("dirid")]:0;var a=void 0!==e.attr("data-show-unvisible")&&"true"==e.attr("data-show-unvisible").toLowerCase();void 0!==e.data("prevdirid")&&t==e.data("prevdirid")||(e.data("prevdirid",t),e.find(".title").text(""),e.find(".accordion").empty(),Directory.getDirectoryMenuData({Ids:t,WebsiteId:"undefined"!=typeof SiteId?SiteId:0,showUnvisible:a}).done((function(t){if(void 0!==t){e.find(".title").text(t.title);const a=`#${e.find(".accordion").attr("id")}`;$.each(t.children,(function(n,i){if(e.find(".title").text(t.title),null!=i.children){var d=$($("#TemplateAccordionItem").html()).clone();d.find(".sectitle").text(i.title),d.find(".accordion-header").attr("id",`secheader${i.id}`);const t=d.find(".accordion-collapse").attr({"aria-labelledby":`secheader${i.id}`,id:`seccollapse${i.id}`,"data-bs-parent":`${a}`});d.find(".accordion-button").attr({"data-bs-target":`#seccollapse${i.id}`,"aria-controls":`seccollapse${i.id}`});var o=d.find(".accordion-body");$.each(i.children,(function(e,a){const n=$(`<a href="${a.routerName}" title="連結至：${a.title}" class="list-group-item list-group-item-action border-0 py-3">${a.title}</a>`);"undefined"!=typeof PageKey&&PageKey.toLowerCase()==a.routerName.toLowerCase()&&($(n).addClass("active"),$(t).collapse("show"),d.find(".accordion-header").addClass("active")),o.append(n)})),e.find(".accordion").append(d)}else{const t=null!=i.routerName&&""!=i.routerName?i.routerName:i.linkUrl;var r=$(`<div class="accordion-item border-0 border-bottom px-1"><a href="${t}" title="連結至：${i.title}" class="list-group-item border-0 py-3 custom_h5 text-black"><span>${i.title}<span></a></div>`);if(null!=i.imgUrl&&""!=i.imgUrl){const e=$('<img alt=" " />');null==i.overImgUrl||"undefined"!=typeof PageKey&&t.toLowerCase().indexOf(PageKey.toLowerCase())>=0?e.attr("src",i.imgUrl):e.attr("src",i.overImgUrl),$(r).find("a").removeClass("py-3").addClass("p-0 imgMenu").append(e)}"undefined"!=typeof PageKey&&PageKey.toLowerCase()==i.routerName.toLowerCase()&&$(r).find("a").addClass("active"),e.find(".accordion").append(r)}})),$(".selectList").length>0&&$(window).trigger("resize.selectList")}})))})),$(".advertise_directory").each((function(){const e=$(this),t=void 0!==e.data("dirid")?"string"==typeof e.data("dirid")?e.data("dirid").split(","):[e.data("dirid")]:0;Directory.getDirectoryAdvertiseData({Ids:t,WebsiteId:"undefined"!=typeof SiteId?SiteId:0,showUnvisible:!0}).done((function(t){DirectoryAdDataInsert(e,t)}))})),1==e&&("onhashchange"in window?window.onhashchange=hashChangeDirectory:setInterval(hashChangeDirectory,1e3))}function hashChangeDirectory(e){e?(initElemntAndLoadDir(),e.preventDefault()):console.log("HashChange錯誤")}function DirectoryDataGet(e,t){const a=$(".catalog_frame").length;let n=parseInt(t.Page);"search"==e.data("type")?$.extend(!0,t,{Type:"search",SearchText:e.data("search-text").toString(),StartDate:e.data("startDate"),EndDate:e.data("endDate")}):"undefined"!=e.data("type")&&$.extend(!0,t,{Type:e.data("type")}),Directory.getDirectoryData(t).done((function(i){let d=2;"search"==t.Type&&$(".searchCount").text(i.totalCount),e.find(".page-item").each((function(){var e=$(this);e.hasClass("btn_prev")||e.hasClass("btn_next")||e.remove()})),i.totalPage<=1?e.find(".page_btn").addClass("d-none"):e.find(".page_btn").removeClass("d-none"),n>i.totalPage?n=i.totalPage:n<1&&(n=1),1==n?e.find(".btn_prev").addClass("d-none"):e.find(".btn_prev").removeClass("d-none"),n==i.totalPage?e.find(".btn_next").addClass("d-none"):e.find(".btn_next").removeClass("d-none"),1!=n&&n!=i.totalPage||(d=4);for(var o=1;o<=i.totalPage;o++)1==o?o==n?e.find(".page_btn").children(".btn_next").before(`<li class="page-item"><span class="btn_page page-link text-black bg-secondary" data-page=${o}>1</span></li>`):(e.find(".page_btn").children(".btn_next").before(`<li class="page-item"><button class="btn_page page-link text-black" title="第一頁" data-page=${o}>1</button></li>`),n-d-1>0&&e.find(".page_btn").children(".btn_next").before('<li class="page-item px-2">...</li>')):o==i.totalPage?o==n?e.find(".page_btn").children(".btn_next").before(`<li class="page-item"><span class="btn_page page-link text-black bg-secondary" data-page=${o}>${i.totalPage}</span></li>`):(n+d+1<i.totalPage&&e.find(".page_btn").children(".btn_next").before('<li class="page-item px-2">...</li>'),e.find(".page_btn").children(".btn_next").before(`<li class="page-item"><button class="btn_page page-link text-black" title="最後一頁" data-page=${o}>${i.totalPage}</button></li>`)):o>=n-d&&o<=n+d&&(o==n?e.find(".page_btn").children(".btn_next").before(`<li class="page-item"><span class="btn_page page-link text-black bg-secondary" data-page=${o}>${o}</span></li>`):e.find(".page_btn").children(".btn_next").before(`<li class="page-item"><button class="btn_page page-link text-black" title="移動至第${o}頁" data-page=${o}>${o}</button></li>`));if($(".btn_page").off("click").on("click",(function(){var t=$(this);n!=t.data("page")&&(n=t.data("page"),1==a&&window.location.hash!=`#${n}`?window.location.hash=`#${n}`:initElemntAndLoadDir(e,n)),e.goTo()})),e.data("init")||(e.find(".btn_prev > button").on("click",(function(){var t=$(this);n=parseInt(e.data("page"))-1,t.data("page",n),n>=1&&(1==a&&window.location.hash!=`#${n}`?window.location.hash=`#${n}`:initElemntAndLoadDir(e,t.data("page"))),e.goTo()})),e.find(".btn_next > button").on("click",(function(){var t=$(this);n=parseInt(e.data("page"))+1,t.data("page",n),n<=i.totalPage&&(1==a&&window.location.hash!=`#${n}`?window.location.hash=`#${n}`:initElemntAndLoadDir(e,t.data("page"))),e.goTo()}))),e.data("init","true"),i.releInfos.length>0&&1==i.releInfos[0].type){("string"==typeof e.data("hasbuybtn")?"true"===e.data("hasbuybtn").toLowerCase():e.data("hasbuybtn"))&&($("#btn_car_dropdown").length>0||"undefined"==typeof OrgName)?e.addClass("hasBuyBtn"):e.removeClass("hasBuyBtn"),"undefined"==typeof islogin&&"undefined"!=typeof OrgName?Coker.Token.CheckToken().done((function(t){t.success&&(islogin=t.isLogin),DirectoryDataInsert(e,i.releInfos)})):DirectoryDataInsert(e,i.releInfos)}else e.find(".btn_addToCar").length>0&&e.find(".btn_addToCar").addClass("d-none"),DirectoryDataInsert(e,i.releInfos);if(e.data({filter:i.filter,directoryType:i.directoryType}).trigger("load"),e.hasClass("swiper")||e.find(".swiper").length>0||e.hasClass("swiper-wrapper")){let t,a;t=e.hasClass("swiper")?e:e.find(".swiper").length>0?e.find(".swiper"):e.parents(".swiper"),a=$(t).parents('[class*="_swiper"]'),$(a).length>0&&(void 0!==$(a).data("isInit")&&$(a).data("isInit")&&t[0].swiper.destroy(!0,!0),a.data("isInit",!1),SwiperInit({autoplay:!0}))}}))}function DirectoryDataInsert(e,t){if(null==t)return;const a=e.find(".templatecontent").html(),n=e.find(".templatecontent-tag").html(),i="search"==e.data("type"),d=void 0===e.data("dirpath")?"":e.data("dirpath").toLowerCase();0==t.length?e.find(".catalog").addClass("empty"):e.find(".catalog").removeClass("empty"),null!=t&&t.forEach((function(t){var o=$(a).clone();if(e.hasClass("hasBuyBtn"))if(o.find(".btn_addToCar").length>0)o.find(".btn_addToCar").removeClass("d-none");else{o.find("div").first().find("a").first().after('<div class="btn_addToCar"><button>瀏覽商品</button></div>')}else o.find(".btn_addToCar").length>0&&o.find(".btn_addToCar").addClass("d-none");let r,s;if(i||window.location.pathname.toLowerCase().indexOf("search")>0||window.location.pathname.toLowerCase().indexOf("techcert")>0){var l=t.link.split("?filter=");t.link=l[0];var c=l.length>1?"?filter="+l[1]:"";if(3===t.type)r=`${null==t.orgName?"":`/${t.orgName}`}/${t.link}`;else r=`${null==t.orgName?"":`/${t.orgName}`}/search/${t.link}`;if(void 0!==e.data("search-text")&&""!=e.data("search-text")&&(r=`${r}/${encodeURIComponent(e.data("search-text"))}${c}`),s="_blank",t.mainImage.indexOf("youtu")>0){var f="",p=t.mainImage.match(/^.*(?:(?:youtu.be\/|v\/|vi\/|u\/w\/|embed\/)|(?:(?:watch)??v(?:i)?=|&v(?:i)?=))([^#&?]*).*/);null!=p&&p.length>0&&(f=p[1]),t.mainImage="https://img.youtube.com/vi/"+f+"/mqdefault.jpg"}}else{if(r=window.location.pathname.indexOf(t.orgName)>0&&window.location.pathname.toLowerCase().indexOf("home")<0&&window.location.pathname.toLowerCase().indexOf(d)>=0?window.location.pathname:`${null==t.orgName?"":`/${t.orgName}`}${""==d?null==t.orgName?window.location.pathname:window.location.pathname.toLowerCase().replace(`${t.orgName.toLowerCase()}`,""):`/${d}`}`,void 0!==e.data("pageto")&&""!=e.data("pageto")){var g=r.substring(1).indexOf("/")+1;r=r.substring(0,g+1)+e.data("pageto")}r+=t.link,s="_self"}1==t.type&&0!=t.status&&o.find("a").append(`<span class="status status${t.status}">${t.statusName}</span>`),/^http/.test(r)||(r=r.replace("//","/"));const h={href:r,title:`連結至: ${t.title}${"_blank"==s?"(另開視窗)":""}`,target:s};o.length>0&&("A"==o[0].tagName?o.attr(h):o.find("a").attr(h)),e.hasClass("cross_graphics_frame")&&""==t.mainImage&&o.children("div:first").addClass("d-none"),e.hasClass("getlatlng")&&(o.find(".dirname").text(t.dirname),o.find(".dirname").removeClass("d-none"));var m=t.mainImage||"/images/noImg.jpg";if(null!=t.orgName&&("undefined"!=typeof IsFaPage&&"undefined"!=typeof OrgName&&!IsFaPage||"undefined"!=typeof OrgName&&OrgName!=t.orgName)&&(m=m.replace("upload",`upload/${t.orgName}`)),o.find("img").attr("src",m),o.find("img").imgCheck().attr("alt",`${t.title}的主要圖片`),o.find(".title").text(t.title),o.find(".subtitle").text(t.subtitle),o.find(".description").html(t.description),o.is("a")?o.find("img").length&&o.find("h3,h4,h5,h6,span,p").length&&o.find("img").imgCheck().attr("alt"," "):o.find("a img").length&&o.find("a").find("h3,h4,h5,h6,span,p").length&&o.find("img").imgCheck().attr("alt"," "),o.find(".location").length>0&&(null==t.location||""==t.location)?o.find(".location").parents(".py-2").remove():o.find(".location").text(t.location),o.find(".address").length>0&&(null==t.address||""==t.address)?o.find(".address").parents(".py-2").remove():o.find(".address").text(t.address),null!=t.startTime&&""!=t.startTime){var u=new Date(t.startTime);o.find(".startTime").text(`${u.getFullYear()}/${u.getMonth()+1}/${u.getDate()}`)}else o.find(".startTime").each(((e,t)=>{"span"==t.tagName.toLowerCase()?$(t).parent().remove():$(t).remove()}));if(null!=t.nodeDate&&""!=t.nodeDate){var v=new Date(t.nodeDate);o.find(".date").text(`${v.getFullYear()}/${v.getMonth()+1}/${v.getDate()}`),o.find(".date-month").text(`${v.getMonth()+1}月`),o.find(".date-monthyear").text(`${v.getMonth()+1}/${v.getFullYear()}`),v.getDate()<10?o.find(".date-day").text(`0${v.getDate()}`):o.find(".date-day").text(`${v.getDate()}`),v.getMonth()<9?o.find(".date-month-number").text(`0${v.getMonth()+1}`):o.find(".date-month-number").text(`${v.getMonth()+1}`),o.find(".date-year").text(`${v.getFullYear()}`)}else o.find(".date,.date-month,date-monthyear,date-day").each(((e,t)=>{"span"==t.tagName.toLowerCase()?$(t).parent().remove():$(t).remove()}));if(null!=t.price?(o.find(".normal-price").text(t.price.toLocaleString()),0!=t.oriPrice&&null!=t.oriPrice&&t.price!=t.oriPrice?(o.find(".price-grid").removeClass("price"),o.find(".price-grid").empty(),o.find(".price-grid").append(`<div class="text-decoration-line-through">$${t.oriPrice}</div><div class="text-danger">會員價 $${t.price}</div>`)):o.find(".price-grid").text(t.price)):(o.find(".price").addClass("notshow"),o.find(".price").text("")),null!=t.itemNo&&""!=t.itemNo?o.find(".itemNo").text(t.itemNo):o.find(".itemNo").remove(),$tags=o.find(".tags"),$tags.empty(),null==t.tags&&(t.tags=[]),t.tags.slice(0,2).forEach((e=>{let t=$(n).clone();t.text(e.tag_Name),t.data("tagname",e.tag_Name),$tags.append(t)})),t.tags.slice(2).forEach((e=>{let t=$(n).clone();t.text(e.tag_Name.slice(0,4)),t.data("tagname",e.tag_Name),t.addClass("more-tag d-none"),$tags.append(t)})),t.tags.length>2){let e=$(n).clone();e.text("..."),e.data("tagname","..."),e.addClass("less-tag"),$tags.append(e)}$tags.children().each((function(){var e=$(this);e.hasClass("less-tag")||e.on("click",(function(){var t=e.data("tagname");return location.href=`/${OrgName}/Search/Get/3/${encodeURIComponent(t)}`,!1}))})),o.find(".shareBlock").data("init",!1),o.find(".shareBlock > a").remove(),o.find(".shareBlock").data("href",r),1==t.type&&"undefined"!=typeof IsLogin&&IsLogin&&ProdFavBtnSet(o,t),e.find(".catalog").append(o),1==t.type&&o.find(".btn_addToCar").length>0&&o.find(".btn_addToCar").on("click",(function(){window.location.href=r}))})),HoverEffectInit(),ShareBlockInit();var o=window.location.pathname;if(o.indexOf("Search")>0)o=o.substring(0,o.indexOf("Search")+6);else if(o.lastIndexOf("_")>0){var r=o.substring(o.lastIndexOf("_")+1);$.isNumeric(r)&&(o=o.substring(0,o.lastIndexOf("_")))}if(void 0!==localStorage[`switchViewType-${o}`]&&i){var s=localStorage[`switchViewType-${o}`];$(`button.${s}`).trigger("click")}}function ProdFavBtnSet(e,t){var a=`<button data-pid="${t.id}" class="btn_fav"></button>`;e.find(".shareBlock").after(a),e.find(".shareBlock").hasClass("d-none")?e.find(".btn_fav").addClass("d-none"):e.find(".shareBlock").hasClass("type5")&&e.find(".btn_fav").addClass("type5"),null!=t.fId&&(e.find(".btn_fav").data("fid",t.fId),e.find(".btn_fav").addClass("check"),e.find(".btn_fav").attr("title","移除收藏")),FavButtonInit(e.find(".btn_fav"))}function DirectoryAdDataInsert(e,t){if(e.find(".swiper").length>0)for(var a=e.find(".swiper-wrapper"),n=0;n<t.length;n++){var i=$(a.find(".templatecontent").html()).clone();i=InsertAdDatat(i,t[n]),a.append(i)}else e.find(".File_Frame").each((function(e){var a=$(this);t.length>e&&InsertAdDatat(a,t[e])}))}function InsertAdDatat(e,t){var a="undefined"!=typeof OrgName,n=t.fileLink[0],i=n.fileType;if(a||void 0===e.data("init")){switch(parseInt(i)){case 1:var d=e.find(".img_frame");d.find("img").attr("src",n.link),d.find("img").attr("alt",t.title),d.find("a").attr("href",t.link),d.find("a").attr("title","連結至"+t.title+(t.target?"(開新視窗)":"")),d.find("a").attr("target",t.target?"_blank":"_self"),e.find(".title").length>0&&(e.find(".title").text(t.title),e.find(".title").removeClass("d-none")),d.removeClass("d-none"),d.parent().children().not(".img_frame").not(".keep").remove();break;case 2:var o=e.find(".video_frame");o.find("video").attr("src",n.link),o.find("video").attr("type",n.video_Type),o.removeClass("d-none"),o.parent().children().not(".video_frame").remove();break;case 3:var r=e.find(".YT_frame");if(r.find("img").attr("src","https://img.youtube.com/vi/"+n.name+"/maxresdefault.jpg"),r.find("img").attr("alt",t.title),r.removeClass("d-none"),r.parent().find("div").not(".YT_frame").remove(),0==$("body").find("#YTPreviewModal").length){$("body").prepend('<div class="modal fade" id="YTPreviewModal" tabindex="-1" aria-labelledby="YTPreviewModal" aria-hidden="true">\n                                                  <div class="modal-dialog modal-xl">\n                                                    <div class="modal-content position-relative bg-black">\n                                                        <div class="modal-header">\n                                                        <button type="button" data-bs-dismiss="modal" aria-label="Close" class="bg-light btn-close rounded-circle"</button>\n                                                        </div>\n                                                        <div class="modal-body"></div>\n                                                    </div>\n                                                  </div>\n                                                </div>'),$("#YTPreviewModal").find(".modal-content").css("height","90vh"),document.getElementById("YTPreviewModal").addEventListener("hidden.bs.modal",(function(e){$("#YTPreviewModal").find(".modal-body").empty()}))}r.on("click",(function(){var e=`https://www.youtube-nocookie.com/embed/${n.name}?&autoplay=1`;$("#YTPreviewModal").find(".modal-body").append(`<iframe src="${e}" class="w-100 h-100" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`)})),r.parent().children().not(".YT_frame").remove()}var s;if(null!=t.describe&&e.find(".describe").length>0)(t.describe+"").split("\n").forEach((function(e,t){0==t?s=e:s+=`<br/>${e}`})),e.find(".describe").append(s);if(e.find(".tag").length>0){for(var l="",c=0;c<t.tagDatas.length;c++){l+=`<a href="${"undefined"==typeof OrgName?"":`/${OrgName}/Search/Get/${t.tagDatas[c].searchId}/${t.tagDatas[c].title}`}" title="連結至：${t.tagDatas[c].title}" class="pe-2">#${t.tagDatas[c].title}</a>`}e.find(".tag").append(l)}a&&Advertise.ActivityExposure(t.id).done((function(e){})),e.find(".video_frame").find("video").on("play",(function(){$(this).hasClass("playing")||($(this).addClass("playing"),Advertise.ActivityClick(t.id).done((function(e){})))})),e.find(".video_frame").find("video").on("ended",(function(){$(this).hasClass("playing")&&$(this).removeClass("playing")})),e.on("click",(function(){0==e.find(".video_frame").length&&Advertise.ActivityClick(t.id).done((function(e){}))})),e.find(".detectLang").each((function(){var e=$(this);const t=e.html().replace(/([a-zA-Z]+)/g,'<span class="english">$1</span>');e.html(t)})),e.data("init",!0)}return e}function FavButtonInit(e){e.on("click",(function(){$self=$(this),$self.hasClass("check")?void 0!==e.data("fid")&&""!=typeof e.data("fid")&&Coker.Favorites.Delete(e.data("fid")).done((function(t){t.success?(e.data("fid",""),$self.removeClass("check"),e.attr("title","加入收藏"),Coker.sweet.success("已將商品從收藏中移除",null,!0)):console.log(t.message)})):Coker.Favorites.Add(e.data("pid")).done((function(t){t.success?(e.data("fid",t.message),$self.addClass("check"),e.attr("title","移除收藏"),Coker.sweet.success("成功將商品加入收藏",null,!0)):console.log(t.message)}))}))}
function FrameInit(){$(".masonry").each((function(){var t=$(this);if(!t.data("isInit")){$(this).find(".grid").masonry({itemSelector:".grid-item",columnWidth:".grid-item"});t.data("isInit",!0)}})),$(".YTmodal_frame").each((function(){var t=$(this);if(void 0===t.data("isinit")){if(void 0!==t.attr("link")&&""!=t.attr("link")){var i="";if(t.attr("link").includes("v=")){var a=(d=t.attr("link").substring(30)).indexOf("v=")+2,e=d.indexOf("&",a);i=e>=0?d.substring(a,e):d.substring(a)}else{var d,r=(d=t.attr("link").substring(30)).indexOf("?");i=r>=0?d.substring(0,r):d.substring(a)}t.attr("vid",i),void 0!==t.attr("vid")?i=t.attr("vid"):(i=t.attr("link").substring(t.attr("link").indexOf("v=")+2),t.attr("vid",i));var n=`http://img.youtube.com/vi/${i}/hqdefault.jpg`;t.find("img").attr("src",n)}if(void 0!==t.attr("yttitle")&&""!=t.attr("yttitle")&&t.find("img").attr("alt",t.attr("yttitle")),t.find("button").attr({"data-bs-toggle":"modal","data-bs-target":"#YTPreviewModal"}),0==$("body").find("#YTPreviewModal").length){$("body").prepend('<div class="modal fade" id="YTPreviewModal" tabindex="-1" aria-labelledby="YTPreviewModal" aria-hidden="true">\n                                                      <div class="modal-dialog modal-xl">\n                                                        <div class="modal-content bg-black">\n                                                            <div class="modal-header">\n                                                            <button type="button" data-bs-dismiss="modal" aria-label="Close" class="bg-light btn-close rounded-circle"</button>\n                                                            </div>\n                                                            <div class="modal-body"></div>\n                                                        </div>\n                                                      </div>\n                                                    </div>'),document.getElementById("YTPreviewModal").addEventListener("hidden.bs.modal",(function(t){$("#YTPreviewModal").find(".modal-body").empty()}))}t.find("button").on("click",(function(){var i="";i=t.attr("link").includes("v=")?`https://www.youtube-nocookie.com/embed/${t.attr("vid")}?&autoplay=1`:`${t.attr("link")}?&autoplay=1`,$("#YTPreviewModal").find(".modal-body").append(`<iframe src="${i}" class="w-100 h-100" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`)})),t.attr("data-isInit",!0)}}))}
...
function SwiperInit(e){var i={slidesPerView:1,spaceBetween:15,keyboard:{enabled:!0},lazy:{loadPrevNext:!0},on:{init:function(){const e=function(e){e.preventDefault(),$(e.currentTarget).parents(".swiper").find(".outside-item").removeClass("show"),$(e.currentTarget).parents(".swiper-slide").find(".outside-item").addClass("show")},i=function(e){$(".swiper-slide .outside-item").removeClass("show")};$(this.el).find(".hover-outside").off("click").on("click",e),$(this.el).find(".hover-outside").off("mouseover").on("mouseover",e),$(this.el).find(".hover-outside").off("keydown").on("keydown",(function(i){"Enter"!==i.key&&" "!==i.key||e(i)})),$(this.el).find(".outside-item").off("mouseover").on("mouseover",e),$(this.el).find(".hover-outside").off("mouseout").on("mouseout",i),$(this.el).find(".outside-item").off("mouseout").on("mouseout",i),$("body").off("click.disableoutsideItem").off("click.disableoutsideItem").on("click.disableoutsideItem",i),this.isLoopActive=this.params.loop},slideChange:function(){const e=this;if(e.params.loop){const i=$(e.el),t=i.find(".swiper-slide"),s=i.find(":focus").parents(".swiper-slide"),n=t.index(s);void 0!==n&&n>=0&&e.isLoopActive?(e.isLoopActive=!1,e.loopDestroy()):void 0!==n||e.isLoopActive||(e.isLoopActive=!0,e.loopCreate())}}}};if($.fn.extend({swiperBindEven:function(e,i){const t=function(){var i=e.activeIndex,t=(e.realIndex,e.slides[i]);$(t).find("video").length>0||e.autoplay.stop()},s=function(){var i=e.activeIndex,t=(e.realIndex,e.slides[i]);$(t).find("video").length>0||e.autoplay.start()};$(this);$(this).off("mouseover").on("mouseover",t),$(this).find(".swiper-slide a,.swiper-slide").off("focus").on("focus",(function(){const i=($(this).hasClass("swiper-slide")?$(this):$(this).parents(".swiper-slide")).attr("aria-label").split(" / ")[0];e.slideTo(i-1,300),t()})),$(this).off("mouseout").on("mouseout",s),$(this).find("a").on("blob",s),$(this).find("button").prop("disabled",!1),$(window).off("resize.swiper").on("resize.swiper",(function(){const i=e.slides.length,t=e.params.slidesPerView,s=e.navigation.nextEl?e.navigation.nextEl:null,n=e.navigation.prevEl?e.navigation.prevEl:null,a=e.pagination.el;i<=t?(e.autoplay.stop(),s&&!Array.isArray(s)&&s.classList.add("d-none"),n&&!Array.isArray(n)&&n.classList.add("d-none"),a&&a.classList.add("d-none")):(s&&!Array.isArray(s)&&s.classList.remove("d-none"),n&&!Array.isArray(n)&&n.classList.remove("d-none"),a&&a.classList.remove("d-none"))})),$(window).trigger("resize.swiper"),e.update()}}),$(".one_swiper").each((function(){var t=$(this);if(!t.data("isInit")){t.find("video").each((function(){var e=$(this);e.attr("controls")&&(e.removeAttr("controls"),e.prop("muted",!0),e.prop("playsinline",!0))})),void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper";const l=$(s).find(".swiper-slide").parents(".templatecontent,.template_slide");if(1==$(s).find(".swiper-slide").length&&l.length>0)return!1;const p=0===l.length?$(s).find(".swiper-slide").length>1:$(s).find(".swiper-slide").length>2;var n=t.data("effect"),a=t.data("effect-speed");void 0!==n&&!1!==n||(n="slide"),a=void 0===a||!1===a?300:parseInt(a);var r=!!e.autoplay&&p,o=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},on:{slideChangeTransitionEnd:function(){const e=this,i=(this.slides.length,this.previousIndex),s=($(this.slides[i]),$(this.slides[this.activeIndex]).find("video")),n=s.get(0);s.length>0&&(t.off("mouseover"),t.off("mouseout"),e.autoplay.stop(),n.onended=function(){t.on("mouseover"),t.on("mouseout"),e.autoplay.start()}),t.find(".swiper-slide").each((function(){if(parseInt($(this).attr("data-swiper-slide-index"))!=this.realIndex){var e;if($(this).find("iframe").length>0)e=$(this).html();else if($(this).find("video").length>0){var i=$(this).find("video").get(0);i.pause(),i.currentTime=0,i.play()}null!=e&&(t=$(this),s=e,$(t).empty(),$(t).append(s))}var t,s}))}},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},effect:n,speed:a},r?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),d=new Swiper(s,o);o.on.slideChangeTransitionEnd.call(d),t.data("isInit",!0),t.swiperBindEven(d)}})),$(".one_swiper_thumbs").each((function(){var t=$(this);const s=t.index(this);if(t.find(".six_thumbs > .swiper-wrapper").empty(),!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var n="#"+t.attr("id")+" .swiper";const w=$(n).find(".swiper-slide").length>=2;var a=t.data("effect"),r=t.data("effect-speed"),o=new Swiper(".six_thumbs",{spaceBetween:10,slidesPerView:6,freeMode:!0,watchSlidesProgress:!0});void 0!==a&&!1!==a||(a="slide"),r=void 0===r||!1===r?300:parseInt(r);var d=!!e.autoplay&&w,l=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},thumbs:{swiper:o},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},effect:a,speed:r},d?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{});if(w||$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").remove(),!t.find(".swiper").hasClass(".selfThumbs")){const e=[],i=[],s=[];if(t.find(".swiper-slide img").each((function(){e.push($(this).attr("src")),i.push($(this).attr("alt")),$(this).closest(".swiper-slide").hasClass("backstageType")?s.push("backstageType"):s.push("")})),e.length>1)for(let t=0;t<e.length;t++){const n=`<div class="swiper-slide ${s[t]}"><img src="${e[t]}" alt="${i[t]}" /></div>`;o.appendSlide(n)}}o.slideTo(s,0);var p=new Swiper(n,l);t.data("isInit",!0),d&&p.slides.length-2>1&&t.swiperBindEven(p),d&&PauseOnMouseEnter(p,t.find(".swiper"))}})),$(".two_swiper").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper";const o=0===$(s).find(".swiper-slide").parents(".templatecontent,.template_slide").length?$(s).find(".swiper-slide").length:$(s).find(".swiper-slide").length-1,d=o>2;var n=!!e.autoplay&&d,a=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0,renderBullet:function(e,i){return t.has(".swiper_pagination_water").length?'<span class="'+i+' material-symbols-outlined ms-3">water_drop</span>':'<span class="'+i+'"></span>'}},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{400:{slidesPerView:1},1024:{slidesPerView:2}}},n?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{});!d&&o>0?$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").addClass("d-none"):$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").removeClass("d-none");var r=new Swiper(s,a);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(r),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".three_swiper").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper",n=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper-pagination",clickable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{375:{slidesPerView:1},576:{slidesPerView:2},992:{slidesPerView:3}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),a=new Swiper(s,n);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(a),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".four_swiper").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper",n=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper-pagination",clickable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{375:{slidesPerView:1},576:{slidesPerView:3},992:{slidesPerView:4}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),a=new Swiper(s,n);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(a),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".five_swiper").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper",n=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},scrollbar:{el:".swiper-scrollbar",draggable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{320:{slidesPerView:2},375:{slidesPerView:2},576:{slidesPerView:3},769:{slidesPerView:4},1024:{slidesPerView:5}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),a=new Swiper(s,n);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(a),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".six_swiper").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper",n=Object.assign({},i,{pagination:{el:"#"+t.attr("id")+" .swiper_pagination",clickable:!0},scrollbar:{el:".swiper-scrollbar",draggable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"},breakpoints:{320:{slidesPerView:2},375:{slidesPerView:2},576:{slidesPerView:3},769:{slidesPerView:4},1024:{slidesPerView:6}}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{}),a=new Swiper(s,n);t.data("isInit",!0),e.autoplay&&t.swiperBindEven(a),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".picture-category").length>0&&$("#SwiperModal").length>0&&!$(this).data("isinit")){const e=$("#SwiperModal .modal-header .imgalt");e.text("");const i=new Swiper("#pictureSwiperThumbs",{spaceBetween:10,breakpoints:{375:{slidesPerView:2},576:{slidesPerView:3},769:{slidesPerView:4},1024:{slidesPerView:6}},freeMode:!0,watchSlidesProgress:!0}),t=new Swiper("#pictureSwiper",{centeredSlides:!0,spaceBetween:10,loop:!0,loopAdditionalSlides:0,navigation:{nextEl:"#pictureSwiper .swiper-button-next",prevEl:"#pictureSwiper .swiper-button-prev"},pagination:{el:"#pictureSwiper .swiper-pagination"},thumbs:{swiper:i},autoplay:{delay:5e3,disableOnInteraction:!1}});t.on("slideChange",(function(){var i=$(t.wrapperEl).find(".swiper-slide").eq(t.activeIndex);e.text(i.find("img").attr("alt"))})),$(".picture-category a").attr("href","#SwiperModal").on("click",(function(){t.removeAllSlides(),i.removeAllSlides(),t.update(),i.update();var s=$(this).parents(".picture-category"),n=s.find("a").index(this),a=[];if(s.find(".templatecontent img").each((function(){var e={};e.src=$(this).attr("src"),e.alt=void 0===$(this).attr("alt")?"":$(this).attr("alt"),a.push(e)})),e.text(a[n].alt),1==a.length){var r=`<div class="swiper-slide"><img src="${a[0].src}" alt="${a[0].alt}" /></div>`;t.appendSlide(r),t.autoplay.stop()}else{PauseOnMouseEnter(t,$("#pictureSwiper"));for(let e=0;e<a.length;e++){r=`<div class="swiper-slide"><img src="${a[e].src}" alt="${a[e].alt}" /></div>`;t.appendSlide(r);var o=`<div class="swiper-slide align-content-center ms-1 me-2"><img src="${a[e].src}" alt="${a[e].alt}" /></div>`;i.appendSlide(o)}}return t.slideToLoop(n,0),i.slideTo(n,0),$("#SwiperModal").modal("show"),!1})),$(this).data("isinit",!0)}$(".three_two_grid_swiper").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" > .swiper";const r=0===$(s).find(".swiper-slide").parents(".templatecontent,.template_slide").length?$(s).find(".swiper-slide").length:$(s).find(".swiper-slide").length-1,o=r>6;var n=!!e.autoplay&&o;const d=Object.assign({},i,{breakpoints:{375:{slidesPerView:1,grid:{rows:1,fill:"row"}},576:{slidesPerView:2,grid:{rows:1,fill:"row"}},992:{slidesPerView:3,grid:{rows:2,fill:"column"}}},pagination:{el:"#"+t.attr("id")+" .swiper-pagination",clickable:!0},navigation:{nextEl:"#"+t.attr("id")+" .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_button_prev"}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1},loop:!0}:{});!o&&r>0?$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").addClass("d-none"):$(`#${t.attr("id")}`).find(".swiper_button_next,.swiper_button_prev").removeClass("d-none");var a=new Swiper(s,d);t.data("isInit",!0),n&&t.swiperBindEven(a),t.prepend($("#"+t.attr("id")+" .swiper_button_prev"))}})),$(".vertical_swiper_thumbs").each((function(){var t=$(this);if(!t.data("isInit")){void 0===t.attr("id")&&t.attr("id",`id-${Math.random().toString(36).substring(2,9)}-${Date.now()}`);var s="#"+t.attr("id")+" .swiper";const o=(0===$(s).find(".swiper-slide").parents(".templatecontent,.template_slide").length?$(s).find(".swiper-slide").length:$(s).find(".swiper-slide").length-1)>3;var n=!!e.autoplay&&o,a=new Swiper(`#${t.attr("id")} .swiper_thumbs`,{slidesPerView:1,direction:"horizontal",loop:!0,breakpoints:{768:{direction:"vertical",watchSlidesProgress:!0,loop:o}},navigation:{nextEl:"#"+t.attr("id")+" .swiper_thumbs .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper_thumbs .swiper_button_prev"}});const d=Object.assign({},i,{loop:!0,slidesPerView:1,direction:"horizontal",spaceBetween:0,breakpoints:{768:{direction:"vertical",loop:o,slidesPerView:3}},centeredSlides:!0,effect:"coverflow",coverflowEffect:{rotate:0,stretch:0,depth:100,modifier:1,slideShadows:!0},thumbs:{swiper:a},navigation:{nextEl:"#"+t.attr("id")+" .swiper .swiper_button_next",prevEl:"#"+t.attr("id")+" .swiper .swiper_button_prev"}},e.autoplay?{autoplay:{delay:5e3,disableOnInteraction:!1}}:{});var r=new Swiper(s,d);r.on("slideChange",(function(){$(r.slides).each((function(e,i){e<r.activeIndex-1||e>r.activeIndex+1?$(i).addClass("hidden-slide"):$(i).removeClass("hidden-slide")}))})),t.data("isInit",!0),n&&t.swiperBindEven(r),r.slideTo(0),r.loopCreate(),r.update()}}))}function PauseOnMouseEnter(e,i){i.on("mouseenter",(function(){e.autoplay.stop()})),i.on("mouseleave",(function(){e.autoplay.start()}))}
const newEnum=e=>{const t={};return Object.keys(e).forEach((n=>{t[t[n]=e[n]]=n})),t},list_type=newEnum({grid:"Grid",list:"List",text:"Text",product_grid:"Product_Grid",product_list:"Product_List"}),display_configurations={[list_type.list]:["type1 bg-white",{".card-border":"card-border-rd type3",".catalog-number":"d-none",".check_btn":"check_btn-type3",".col":"p-1 type3 box-shadow",".description":"type3-content",".image":"px-0",".image_frame":"h-100",".imgh":"img-h",".item-header":"d-none",".like-and-share":"d-none",".max-h":"max-hei",".mergetag":"merge",".more-btn":"d-none",".more-tag":"d-none",".price-grid":"d-none",".purchase":"d-none",".related-tag":"d-none",".shareBlock":"d-none",".btn_fav":"d-none",".tags":"d-none",".title":"type1-title fw-bold p-2",figcaption:"flex-grow-1 p-3 py-0 py-md-3 pb1"}],[list_type.grid]:["type2 row row-cols-sm-4 bg-white",{".card-border":"card-border-rd type2",".catalog-number":"d-none",".check_btn":"w-100",".col":"p-1 type2 box-shadow",".date":"d-none",".description":"d-none type2-content",".image_frame":"w-100",".item-header":"d-none",".like-and-share":"d-none",".more":"d-none",".more-btn":"d-none",".more-tag":"d-none",".price-grid":"d-none",".purchase":"d-none",".related-tag":"d-none",".shareBlock":"d-none",".btn_fav":"d-none",".tags":"d-none",".title":"type1-title fw-bold p-2",figcaption:"pb1",figure:"flex-column"}],[list_type.text]:["type3 row row-cols-sm-4 bg-white",{".card-border":"pr3 type1",".catalog-number":"d-none",".check_btn":"w-100",".col":"p-1 type1 text-border box-shadow",".date":"d-none",".description":"d-none",".image":"d-none",".image_frame":"d-none",".item-header":"d-none",".like-and-share":"d-none",".more":"d-none",".more-tag":"d-none",".price-grid":"d-none",".purchase":"d-none",".related-tag":"d-none",".shareBlock":"d-none",".btn_fav":"d-none",".search-more":"d-none",".tags":"d-none",".title":"type2-title pr3 h-100",figure:"flex-column"}],[list_type.product_grid]:["type4 row row-cols-lg-4 row-cols-md-2 row-cols-2  bg-light px-2",{".card-border":"card-border-rd type2",".catalog-number":"d-none",".check_btn":"w-100",".col":"p-1 type4 rounded-lg h-100",".date":"d-none",".description":"d-none type2-content",".image_frame":"type4-image-frame w-100",".item-header":"d-flex",".like-and-share":"d-none",".more":"d-none",".more-btn":"d-none",".more-tag":"d-none",".purchase":"d-none",".shareBlock":"type4",".btn_fav":"type4",".tags":"align-text-bottom",".title":"type4-title d-inline",figcaption:"pb1 type4-caption d-flex flex-column",figure:"flex-column"}],[list_type.product_list]:["type1 bg-light px-2",{".bottom-row":"mt-auto",".card-border":"card-border-rd type2",".catalog-number":"type4-title d-inline",".check_btn":"check_btn-type3",".col":" type5 rounded-lg",".description":"type3-content",".image":"px-0",".image_frame":"type5-image-frame",".imgh":"img-h",".item-header":"d-none",".item-title":"d-lg-flex",".less-tag":"d-none",".like-and-share":"d-inline ms-auto fs-5 p-2",".max-h":"max-hei",".mergetag":"merge",".more":"d-none",".more-btn":"d-none",".price-grid":"d-none",".purchase":"ms-auto d-inline",".related-tag":"d-none",".shareBlock":"type5",".btn_fav":"type5",".tags":"mt-auto mb-2 align-text-bottom d-lg-flex",".title":"type4-title d-inline p-2",figcaption:"flex-grow-1 d-flex flex-column"}]};function ViewTypeChangeInit(){$(".type_change_frame").each((function(){var e=$(this);if(!e.data("isInit")){const d=e.find(".btn_grid"),a=e.find(".btn_list"),c=e.find(".btn_text"),l=e.find(".btn_prod_grid"),s=e.find(".btn_prod_list"),g=e.find(".content").first(),p={[list_type.grid]:d,[list_type.list]:a,[list_type.text]:c,[list_type.product_grid]:l,[list_type.product_list]:s};var t=window.location.pathname;if(t.indexOf("Search")>0)t=t.substring(0,t.indexOf("Search")+6);else if(t.lastIndexOf("_")>0){var n=t.substring(t.lastIndexOf("_")+1);$.isNumeric(n)&&(t=t.substring(0,t.lastIndexOf("_")))}for(const[n,o]of Object.entries(p))o.on("click",(function(){if(!o.data("activate")){var i=o.attr("class").split(" ").filter((e=>e.startsWith("btn_"))).toString().replaceAll(",",".");e.find(".switch_control > button:not(.d-none)").length>1&&localStorage.setItem(`switchViewType-${t}`,i),typeChange(o,p,g,n)}}));var o=!1;if(void 0!==localStorage[`switchViewType-${t}`]){if(t.indexOf("Search")<0)if(e.find(".switch_control > button:not(.d-none)").length>1){var i=localStorage[`switchViewType-${t}`];$(`button.${i}`).trigger("click")}else localStorage.removeItem(`switchViewType-${t}`),e.find(".switch_control > button:not(.d-none)").trigger("click");o=!0}o||(d.length>0&&!d.hasClass("d-none")?d.trigger("click"):a.length>0&&!a.hasClass("d-none")?a.trigger("click"):l.length>0&&!l.hasClass("d-none")?l.trigger("click"):s.length>0&&!s.hasClass("d-none")?s.trigger("click"):c.length>0&&!c.hasClass("d-none")&&c.trigger("click"));var r=0;for(const[e,t]of Object.entries(p))(0===t.length||t.hasClass("d-none"))&&(r+=1);r>=4?e.find(".switch_control").addClass("d-none"):e.find(".switch_control").removeClass("d-none")}e.data("isInit",!0)}))}function updateStyle(e,t){for(const[t,n]of Object.entries(display_configurations)){e.removeClass(n[0]);for(const[t,o]of Object.entries(n[1]))e.find(t).removeClass(o)}e.addClass(t[0]);for(const[n,o]of Object.entries(t[1]))e.find(n).addClass(o)}function typeChange(e,t,n,o){for(const[e,n]of Object.entries(t))n.data("activate",0),n.addClass("text-black-50");e.data("activate",1),e.removeClass("text-black-50"),n.each((function(){updateStyle($(this),display_configurations[o])}))}
function date_input_change(t){var a=$(`#${t}`),n=a.attr("data-daterange"),e=a.attr("data-location"),i=a.attr("data-addr"),d=a.attr("data-organizer"),r=a.attr("data-a-organizer"),s=a.attr("data-r-organizer"),o=a.attr("data-link"),l=a.attr("data-tel"),v=a.find(".activity_start_time").parents("div").eq(1);""==n?$(v).addClass("d-none"):$(v).removeClass("d-none");var f=a.find(".activity_location").parents("div").eq(0);""==e?$(f).addClass("d-none"):($(f).find("a").attr({href:`https://www.google.com.tw/maps/place/${e}`,title:`連結至：${e}(另開新視窗)`,target:"_blank"}),$(f).removeClass("d-none"));var c=a.find(".activity_addr").parents("div").eq(0);""==i?$(c).addClass("d-none"):($(c).find("a").attr({href:`https://www.google.com.tw/maps/place/${i}`,title:`連結至：${i}(另開新視窗)`,target:"_blank"}),$(c).removeClass("d-none"));var m=a.find(".activity-organizer").parent("div").eq(0);""==d?$(m).addClass("d-none"):$(m).removeClass("d-none");var g=a.find(".activity-a-organizer").parent("div").eq(0);""==r?$(g).addClass("d-none"):$(g).removeClass("d-none");var h=a.find(".activity-r-organizer").parent("div").eq(0);if(0==h.length){const t=$(g).clone();t.find("div, span").removeAttr("id"),t.removeAttr("id").removeClass("d-none"),t.find("div > span").length>0?t.find("div > span").text("執行單位"):t.find("div").text("執行單位"),t.find(".activity-a-organizer").removeClass("activity-a-organizer").addClass("activity-r-organizer"),h=t,$(g).after(t)}void 0!==s&&""!=s?($(h).removeAttr("id").removeClass("d-none"),$(h).find(".activity-r-organizer").text(s)):$(h).remove();var C=a.find(".activity_link").parents("div").eq(0);""==o?$(C).addClass("d-none"):($(C).find("a").attr({href:o,title:"連結至：活動網站(另開新視窗)",target:"_blank"}),$(C).removeClass("d-none"));var _=a.find(".activity_tel").parents("div").eq(0);if(""==l?($(_).addClass("d-none"),l="no"):($(_).find("a").attr({href:`tel:${l}`,title:`播打電話：${l}`,target:"_blank"}),$(_).removeClass("d-none")),void 0!==n&&n){const t=n.split("~");a.find(".activity_start_time").html(t[0].trim()),a.find(".activity_end_time").html(t[1].trim())}return a.find(".activity_location").html(e),a.find(".activity_addr").html(i),a.find(".activity-organizer").html(d),a.find(".activity-a-organizer").html(r),a.find(".activity_link").html(o),a.find(".activity_tel").html(l),a.html()}function namecontrol(t){const a=$("#"+t),n=a.find(".btn_text"),e=a.find(".btn_grid"),i=a.find(".btn_list"),d=a.parents(".type_change_frame").first().find(".content").first();n.hasClass("d-none")?n.hasClass("d-none")&&!e.hasClass("d-none")?typeChange(e,i,n,d,"Grid"):n.hasClass("d-none")&&e.hasClass("d-none")&&!i.hasClass("d-none")&&typeChange(i,e,n,d,"List"):typeChange(n,e,i,d,"Text")}
